...
module Asset = {
  ...
  module Logo = {
    ...
    let opensearchdashboards = logo("Opensearch_icon.svg");
...
module Service = {
  ...
  module Logo = {
    ...
    let make = (~name: string, ~link: string) => {
      ...
      | "etherpad" => displayLogo(Asset.Logo.etherpad, "Etherpad")
      | "opensearch-dashboards" => displayLogo(Asset.Logo.opensearchdashboards, "Opensearch")
      | "murmur" => displayLogo(Asset.Logo.mumble, "Mumble")
      ...
      | "status" => displayLogo(Asset.Logo.status, "Zuul Status")
      | _ => React.null
      };
    };
  };
